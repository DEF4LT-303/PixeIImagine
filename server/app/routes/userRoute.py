...
user_blueprint.route('/<_id>', methods=['GET'])(jwt_required()(verify_admin(get_user)))
user_blueprint.route('/email/<email>', methods=['GET'])(get_user_by_email)
user_blueprint.route('/<_id>', methods=['PUT'])(jwt_required()(verify_token(update_user)))
user_blueprint.route('/<_id>', methods=['DELETE'])(jwt_required()(verify_token(delete_user)))
