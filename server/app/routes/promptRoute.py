from app.controllers.promptController import get_prompts, get_prompt, create_prompt, delete_prompt
...
prompt_blueprint.route('/create', methods=['POST'])(jwt_required()(create_prompt))
