...
post_blueprint.route('/post/<_id>', methods=['GET'])(get_post)
post_blueprint.route('/create', methods=['POST'])(jwt_required()(create_post))
post_blueprint.route('/post/<_id>', methods=['PUT'])(jwt_required()(verify_author(update_post)))
post_blueprint.route('/post/<_id>', methods=['DELETE'])(jwt_required()(verify_author(delete_post)))